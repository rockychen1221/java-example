...
public class Xirr {
    ...
    private Investment createInvestment(Transaction tx) {
        ...
        result.years = DAYS.between(tx.when, details.end) / days;
        return result;
    }
     ...
     */
    public double xirr() {
        final double years = DAYS.between(details.start, details.end) / days;
    ...
    public static class Builder {
        ...
        public Xirr build() {
            return new Xirr(transactions, builder, days, guess);
        }
